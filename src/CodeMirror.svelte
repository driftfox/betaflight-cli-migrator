...
.CodeMirror-wrap pre.CodeMirror-line-like) {
  ...
  .CodeMirror-linenumber) {
    ...
    :global(.CodeMirror-line::selection, .CodeMirror-line > span::selection, .CodeMirror-line > span > span::selection) {
        background: #d7d4f0;
    }

    :global(.CodeMirror-line::-moz-selection, .CodeMirror-line > span::-moz-selection, .CodeMirror-line > span > span::-moz-selection) {
        background: #d7d4f0;
    }
